...
/* =============================================================================
   ...
   Os modelos são carregados uma vez no layout e descem por props: o diálogo
   de lançamento precisa deles e é um componente cliente, que não pode
   consultar o banco.
   ========================================================================== */
...
export default async function LayoutDoApp({ children }: { children: React.ReactNode }) {
  ...
  try {
    [perfil, modelos] = await Promise.all([perfilAtual(), listarModelosPorFluxo()]);
  } catch (erro) {
