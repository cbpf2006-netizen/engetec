...
/* =============================================================================
   ...
   O campo mais usado do app, e por isso o maior: tipografia grande, mono e
...
export function CampoValor({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      >
        <span aria-hidden="true" className="numero text-lg font-medium text-muted-foreground">
          R$
        </span>
        <input
          id={id}
          ...
          className="numero w-full bg-transparent text-2xl font-semibold tracking-tight outline-none placeholder:text-muted-foreground/60"
        />
      </div>
